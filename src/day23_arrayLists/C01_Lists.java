...
public class C01_Lists {
    ...
    public static void main(String[] args) {
        ...
        List<Integer> sayilar1 = new ArrayList<>();  // Listlerde primitive data turleri kullanilamaz. kullanmak istersek wrapper class lari kullanabiliriz
        sayilar1.add(5);
        sayilar1.add(3);
        sayilar1.add(2);
        ...
        System.out.println(sayilar1.set(0,12)); // 5  silenen elemanı dondurur bu sekilde sout yaparsak
