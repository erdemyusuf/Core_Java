...
public class C03_ClassVariables {
    public static void main(String[] args) {
       ...
       /*
         ...
         ve kullanabiliriz
         */
        C02_StaticVariables.staticMethod(); // 10  bu class taki metodu calistiracak.C02 ye gidip  bu metodu bulur baslangıc degeri neyse onu calıistırır
        System.out.println(C02_StaticVariables.staticSayi); //10 C02 classındaki variableye gidecek
        ...
        obje1.staticOlmayanMethod(); // 10 static sayi baslangıc degerini aldi  // bu method icinde staticSayi=20 oldu

        System.out.println(obje1.isim); // Mehmet
        System.out.println(obje1.degersizInstanceVariable); // 0 int oldugu icin sıfır oldu
        System.out.println(C02_StaticVariables.staticSayi); // 20 29.satır sonrası deger 20 oldu ve buu yazdırdı
        /*
