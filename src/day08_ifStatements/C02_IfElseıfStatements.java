...
public class C02_IfElseıfStatements {
    ...
    public static void main(String[] args) {
        ...
        double note = scan.nextDouble();  // ondalikli sayi girince virgul ile kabul etti
        // normalde noktayi algilamasi gerekirdi turkce klavyeden oldu


        if (note < 0 || note > 100) {    //&& ile baglanmaz cunku  sayi hem > hem < olamaz yani bir aralik var
