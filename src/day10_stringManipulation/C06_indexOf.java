...
public class C06_indexOf {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(str.indexOf('g')); // 6  //  indexOf CHAR OLARAK DA DONDURUR

        System.out.println(str.indexOf("t")); //  t yok -1 doner.bu metotinteger donduruyor
        ...
        // str5'de p harfi var midir ?, = karakteri var midir? vb....
