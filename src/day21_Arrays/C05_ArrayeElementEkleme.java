...
public class C05_ArrayeElementEkleme {
    public static void main(String[] args) {
        ...
        sinifListesi=elemanEkle(sinifListesi,eklenecekIsim);  // arraye element ekleme icin  metot olusturduk.
        System.out.println(Arrays.toString(sinifListesi));
    }
    public static String[] elemanEkle(String[] sinifListesi, String eklenecekIsim) {
        String [] yeniSinifListesi= new String[sinifListesi.length+1]; // [null, null, null, null]  // array olusturduk yeni liste icin
        // eski listeden 1 eleman fazla uzunlukta yeni bir array olusturdum


        for (int i = 0; i <sinifListesi.length ; i++) {  // eski array deki elemanlari yeniye tasıdık
            yeniSinifListesi[i]=sinifListesi[i];
        }
        // oncelikle eski listedeki tum elemanlari, yeni listeye tasidim

        yeniSinifListesi[yeniSinifListesi.length-1]=eklenecekIsim;   // son index'e ise eklenecek ismi atadim
