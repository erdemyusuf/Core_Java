...
public class C04_ArrayOlustur {
    public static void main(String[] args) {
        ...
        int[] sayilar= arrayOlustur();  //  array i metottan getirecek
    ...
    public static int[] arrayOlustur() {
        ...
        int[] olusturulan =new int[uzunluk];  // array uuznlugunu kullanicidan aldik
        for (int i = 0; i <uzunluk ; i++) {
            System.out.println(i +". index icin sayi giriniz" );
            olusturulan[i]=scan.nextInt();
        }
        return olusturulan;  // return type void degil int, bu yuzden return ile metot call yaptık
    }
}