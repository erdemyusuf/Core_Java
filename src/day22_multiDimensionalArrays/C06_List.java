...
public class C06_List {
 ...
 /*
        ...
        System.out.println(isimler); // [] array de oldugu gibi Array.toString icine yazmaya gerek yok direkt sout icine yazarız

        // bir list'e eleman eklemek istersek
        isimler.add("Basak");
        System.out.println(isimler.add("Ayse")); // true doner. sonuc olarak boolean dondurur
