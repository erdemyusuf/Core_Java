...
public class C08_addAll {
    public static void main(String[] args) {
        ...
        sayilar1.addAll(sayilar2); // iki tane addall var .collection ve baş index ve colectionlu olan var
        System.out.println(sayilar1); // [5, 3, 2, 10, 15, 16, 20]

        sayilar1.addAll(1,sayilar2); // iki tane addall var .collection ve baş index ve collectionlu olan var
